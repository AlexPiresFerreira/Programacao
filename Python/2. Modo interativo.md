...
- O modo interativo permite executar comandos Python e ver o resultado imediatamente.
- É muito útil para testes rápidos e estudo.

## Como iniciar

- Digitando apenas o interpretador:
...
- Ou executando um script em modo interativo:
...
- É um ambiente em que o código é executado linha por linha.
- O resultado aparece na hora, sem precisar criar um arquivo toda vez.