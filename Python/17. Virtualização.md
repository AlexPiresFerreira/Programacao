...
- Quando ativado, normalmente aparece algo como:
    - `(venv)`

### Python — criando ambiente com `virtualenv` (modo clássico)
...
- `virtualenv -p python3 geo_env` → cria ambiente com Python 3.
- Depois de ativar, você instala libs só dentro desse ambiente.

### Para que serve

- Isolar dependências por projeto.
- Evitar conflitos entre bibliotecas de versões diferentes.