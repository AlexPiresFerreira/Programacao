...
- Mostra os nomes disponíveis no escopo atual
- Com argumento, mostra os atributos do objeto
...
- Mostra a documentação de funções, classes, módulos e objetos
...
- Use o modo interativo para testar comandos pequenos
- Use `help()` quando quiser entender melhor uma função
- Use `dir()` para explorar atributos e métodos